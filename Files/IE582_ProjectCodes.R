...
library(ranger)
library(glmnet)
full_data = fread("IE582_Fall20_ProjectTrain.csv")
full_test = fread("IE582_Fall20_ProjectTest.csv")

# My team-mate Burak made the latest submission so I am not changing this part of the code
