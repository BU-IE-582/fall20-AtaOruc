...
cvfit=cv.glmnet(health_mat_2, train_pra$absent_hrs,family='gaussian',nfolds=10)
cvfit
lambda_min <- cvfit$lambda.min
lambda_min
# Lasso with Train Set
lassofit <- glmnet(x=health_mat_2, y = train_pra$absent_hrs, alpha = 1,lambda = lambda_min)
...
train_dt_health <- absent[train_ind_dt, ]
test_dt_health <- absent[-train_ind_dt, ]
...
# Prediction measures
table(test_dt_health$absent_hrs, predictions)
#RMSE Value for performance test
RMSE(test_dt_health$absent_hrs,predictions)
```
